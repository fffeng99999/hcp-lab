...
EXP_DIR="tests/exp11_hierarchical_tpbft_parallel_block"
REPORT_OUT="experiments/exp11_hierarchical_tpbft_parallel_block/report"
...
LOADGEN_DB_SCHEMA_PREFIX="${LOADGEN_DB_SCHEMA_PREFIX:-exp11}"
...
echo "========================================"
echo "开始实验11：分层 TPBFT + 并行 Merkle 块"
echo "========================================"
