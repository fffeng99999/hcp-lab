...
var Registry = []Experiment{
	{
		...
		RunScript:   "hcap-lab/experiments/exp1_tx_nodes/run_exp1_tx_nodes.sh",
		ReportDir:   "hcap-lab/experiments/exp1_tx_nodes/report",
		Params: []ParamSchema{
			{Name: "NODES_LIST", Type: ParamTypeListInt, Default: "16,32,64,128,256", Description: "节点数量列表", Required: true},
			...
			{Name: "CHAIN_ID", Type: ParamTypeString, Default: "hcap-exp1", Description: "链ID", Required: false},
	...
	},
	{
		...
		RunScript:   "hcap-lab/experiments/exp2_storage_share/run_exp2_storage_share.sh",
		ReportDir:   "hcap-lab/experiments/exp2_storage_share/report",
		Params: []ParamSchema{
			...
			{Name: "CHAIN_ID", Type: ParamTypeString, Default: "hcap-exp2", Description: "链ID", Required: false},
			{Name: "LOADGEN_DB_ISOLATION", Type: ParamTypeBool, Default: true, Description: "数据库隔离", Required: false},
			{Name: "LOADGEN_DB_RESET", Type: ParamTypeBool, Default: true, Description: "数据库重置", Required: false},
	...
	},
	{
		...
		RunScript:   "hcap-lab/experiments/exp3_parallel_merkle/run_exp3_parallel_merkle.sh",
		ReportDir:   "hcap-lab/experiments/exp3_parallel_merkle/report",
		Params: []ParamSchema{
			{Name: "K_LIST", Type: ParamTypeListInt, Default: "1,2,4,8", Description: "并行度列表", Required: true},
			{Name: "TX_LIST", Type: ParamTypeListInt, Default: "100,1000,10000", Description: "交易数量列表", Required: true},
			{Name: "REPEAT", Type: ParamTypeInt, Default: 5, Description: "重复次数", Required: false},
			{Name: "NODE_COUNT", Type: ParamTypeInt, Default: 16, Description: "节点数量", Required: false},
			{Name: "PORT_OFFSET", Type: ParamTypeInt, Default: 3000, Description: "端口偏移量", Required: false},
			{Name: "CHAIN_ID", Type: ParamTypeString, Default: "hcap-exp3", Description: "链ID", Required: false},
			{Name: "LOADGEN_DB_ISOLATION", Type: ParamTypeBool, Default: true, Description: "数据库隔离", Required: false},
			{Name: "LOADGEN_DB_RESET", Type: ParamTypeBool, Default: true, Description: "数据库重置", Required: false},
	...
	},
	{
		...
		RunScript:   "hcap-lab/experiments/exp4_hierarchical_consensus/run_exp4_hierarchical.sh",
		ReportDir:   "hcap-lab/experiments/exp4_hierarchical_consensus/report",
		Params: []ParamSchema{
			...
			{Name: "CHAIN_ID", Type: ParamTypeString, Default: "hcap-exp4", Description: "链ID", Required: false},
			{Name: "LOADGEN_DB_ISOLATION", Type: ParamTypeBool, Default: true, Description: "数据库隔离", Required: false},
			{Name: "LOADGEN_DB_RESET", Type: ParamTypeBool, Default: true, Description: "数据库重置", Required: false},
	...
	},
	{
		...
		RunScript:   "hcap-lab/experiments/exp5_hierarchical_tpbft/run_exp5_hierarchical_tpbft.sh",
		ReportDir:   "hcap-lab/experiments/exp5_hierarchical_tpbft/report",
		Params: []ParamSchema{
			{Name: "GROUP_LIST", Type: ParamTypeListInt, Default: "32,16,8,4,2", Description: "分组数量列表", Required: true},
			{Name: "SIG_ALGO_LIST", Type: ParamTypeString, Default: "bls,ed25519", Description: "签名算法列表", Required: false},
			{Name: "NODE_COUNT", Type: ParamTypeInt, Default: 16, Description: "节点数量", Required: true},
			...
			{Name: "CHAIN_ID", Type: ParamTypeString, Default: "hcap-exp5", Description: "链ID", Required: false},
			{Name: "LOADGEN_DB_ISOLATION", Type: ParamTypeBool, Default: true, Description: "数据库隔离", Required: false},
			{Name: "LOADGEN_DB_RESET", Type: ParamTypeBool, Default: true, Description: "数据库重置", Required: false},
	...
	},
	{
		...
		RunScript:   "hcap-lab/experiments/exp6_alpenglow_votor/run_exp6_alpenglow_votor.sh",
		ReportDir:   "hcap-lab/experiments/exp6_alpenglow_votor/report",
		Params: []ParamSchema{
			{Name: "NODES_LIST", Type: ParamTypeListInt, Default: "16,32,64,128,256", Description: "验证节点数量列表", Required: true},
			...
			{Name: "CHAIN_ID", Type: ParamTypeString, Default: "hcap-exp6", Description: "链ID", Required: false},
			{Name: "LOADGEN_DB_ISOLATION", Type: ParamTypeBool, Default: true, Description: "数据库隔离", Required: false},
			{Name: "LOADGEN_DB_RESET", Type: ParamTypeBool, Default: true, Description: "数据库重置", Required: false},
	...
	},
	{
		...
		RunScript:   "hcap-lab/experiments/exp7_pow/run_exp7_pow.sh",
		ReportDir:   "hcap-lab/experiments/exp7_pow/report",
		Params: []ParamSchema{
			{Name: "NODES_LIST", Type: ParamTypeListInt, Default: "16,32,64,128,256", Description: "节点数量列表", Required: true},
			...
			{Name: "CHAIN_ID", Type: ParamTypeString, Default: "hcap-exp7", Description: "链ID", Required: false},
			{Name: "LOADGEN_DB_ISOLATION", Type: ParamTypeBool, Default: true, Description: "数据库隔离", Required: false},
			{Name: "LOADGEN_DB_RESET", Type: ParamTypeBool, Default: true, Description: "数据库重置", Required: false},
	...
	},
	{
		...
		RunScript:   "hcap-lab/experiments/exp8_ibft/run_exp8_ibft.sh",
		ReportDir:   "hcap-lab/experiments/exp8_ibft/report",
		Params: []ParamSchema{
			{Name: "NODES_LIST", Type: ParamTypeListInt, Default: "16,32,64,128,256", Description: "节点数量列表", Required: true},
			...
			{Name: "CHAIN_ID", Type: ParamTypeString, Default: "hcap-exp8", Description: "链ID", Required: false},
	...
	},
	{
		...
		RunScript:   "hcap-lab/experiments/exp9_hotstuff/run_exp9_hotstuff.sh",
		ReportDir:   "hcap-lab/experiments/exp9_hotstuff/report",
		Params: []ParamSchema{
			{Name: "NODES_LIST", Type: ParamTypeListInt, Default: "16,32,64,128,256", Description: "节点数量列表", Required: true},
			{Name: "TX_TOTAL", Type: ParamTypeInt, Default: 100, Description: "总交易数", Required: true},
			{Name: "REPEAT", Type: ParamTypeInt, Default: 5, Description: "重复次数", Required: false},
			...
			{Name: "CHAIN_ID", Type: ParamTypeString, Default: "hcap-exp9", Description: "链ID", Required: false},
			{Name: "HOTSTUFF_NODE_COUNT", Type: ParamTypeInt, Default: 16, Description: "HotStuff节点数", Required: false},
	...
	},
	{
		...
		RunScript:   "hcap-lab/experiments/exp10_raft/run_exp10_raft.sh",
		ReportDir:   "hcap-lab/experiments/exp10_raft/report",
		Params: []ParamSchema{
			{Name: "NODES_LIST", Type: ParamTypeListInt, Default: "16,32,64,128,256", Description: "节点数量列表", Required: true},
			{Name: "TX_TOTAL", Type: ParamTypeInt, Default: 100, Description: "总交易数", Required: true},
			{Name: "REPEAT", Type: ParamTypeInt, Default: 5, Description: "重复次数", Required: false},
			{Name: "PORT_OFFSET", Type: ParamTypeInt, Default: 10000, Description: "端口偏移量", Required: false},
			{Name: "CHAIN_ID", Type: ParamTypeString, Default: "hcap-exp10", Description: "链ID", Required: false},
			{Name: "RAFT_NODE_COUNT", Type: ParamTypeInt, Default: 16, Description: "Raft节点数", Required: false},
	...
	{
		ID:          "exp13_lightweight_tpbft",
		Name:        "实验十三：子组轻量共识变体 TPBFT",
		Description: "分层 TPBFT 子层共识引擎切换对比（PBFT vs Raft）",
		RunScript:   "hcap-lab/experiments/exp13_lightweight_tpbft/run_exp13.sh",
		ReportDir:   "hcap-lab/experiments/exp13_lightweight_tpbft/report",
		Params: []ParamSchema{
			{Name: "GROUP_LIST", Type: ParamTypeListInt, Default: "32,16,8,4,2", Description: "分组数量列表", Required: true},
			{Name: "SUB_CONSENSUS_LIST", Type: ParamTypeString, Default: "pbft,raft", Description: "子层共识类型列表", Required: true},
			{Name: "SIG_ALGO_LIST", Type: ParamTypeString, Default: "bls,ed25519", Description: "签名算法列表", Required: false},
			{Name: "NODE_COUNT", Type: ParamTypeInt, Default: 16, Description: "节点数量", Required: true},
			{Name: "TX_COUNT", Type: ParamTypeInt, Default: 100, Description: "交易数量", Required: true},
			{Name: "REPEAT", Type: ParamTypeInt, Default: 5, Description: "重复次数", Required: false},
			{Name: "PORT_OFFSET", Type: ParamTypeInt, Default: 13000, Description: "端口偏移量", Required: false},
			{Name: "CHAIN_ID", Type: ParamTypeString, Default: "hcap-exp13", Description: "链ID", Required: false},
			{Name: "LOADGEN_DB_ISOLATION", Type: ParamTypeBool, Default: true, Description: "数据库隔离", Required: false},
			{Name: "LOADGEN_DB_RESET", Type: ParamTypeBool, Default: true, Description: "数据库重置", Required: false},
			{Name: "LOADGEN_DB_SCHEMA_PREFIX", Type: ParamTypeString, Default: "exp13", Description: "数据库前缀", Required: false},
		},
	},
	{
		...
		RunScript:   "hcap-lab/experiments/exp12_hotspot_tpbft/run_exp12.sh",
		ReportDir:   "hcap-lab/experiments/exp12_hotspot_tpbft/report",
		Params: []ParamSchema{
			{Name: "GROUP_LIST", Type: ParamTypeListInt, Default: "32,16,8,4,2", Description: "分组数量列表", Required: true},
			...
			{Name: "CHAIN_ID", Type: ParamTypeString, Default: "hcap-exp12", Description: "链ID", Required: false},
			{Name: "LOADGEN_DB_ISOLATION", Type: ParamTypeBool, Default: true, Description: "数据库隔离", Required: false},
			{Name: "LOADGEN_DB_RESET", Type: ParamTypeBool, Default: true, Description: "数据库重置", Required: false},
	...
	},
	{
		...
		RunScript:   "hcap-lab/experiments/exp11_hierarchical_tpbft_parallel_block/run_exp11.sh",
		ReportDir:   "hcap-lab/experiments/exp11_hierarchical_tpbft_parallel_block/report",
		Params: []ParamSchema{
			{Name: "GROUP_LIST", Type: ParamTypeListInt, Default: "32,16,8,4,2", Description: "分组数量列表", Required: true},
			{Name: "K_LIST", Type: ParamTypeListInt, Default: "1,2,4,8", Description: "并行度列表", Required: true},
			{Name: "SIG_ALGO_LIST", Type: ParamTypeString, Default: "bls,ed25519", Description: "签名算法列表", Required: false},
			...
			{Name: "CHAIN_ID", Type: ParamTypeString, Default: "hcap-exp11", Description: "链ID", Required: false},
			{Name: "LOADGEN_DB_ISOLATION", Type: ParamTypeBool, Default: true, Description: "数据库隔离", Required: false},
			{Name: "LOADGEN_DB_RESET", Type: ParamTypeBool, Default: true, Description: "数据库重置", Required: false},
