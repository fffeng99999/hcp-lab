...
var Registry = []Experiment{
	...
	},
	{
		...
		Params: []ParamSchema{
			{Name: "NODE_LIST", Type: ParamTypeListInt, Default: "4,8,16,32", Description: "验证节点数量列表", Required: true},
	...
	},
	{
		...
		Params: []ParamSchema{
			{Name: "NODE_LIST", Type: ParamTypeListInt, Default: "4,8,16,32", Description: "节点数量列表", Required: true},
