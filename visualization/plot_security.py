...
def plot_security(points: List[Tuple[float, float]], output: Path, title: str = "Security") -> None:
    svg = render_line_chart(points, title, "分组规模", "失败概率")
...
<polyline fill="none" stroke="#6c5ce7" stroke-width="2" points="{path}"/>
</svg>"""
