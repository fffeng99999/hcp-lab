...
def plot_latency(points: List[Tuple[float, float]], output: Path, title: str = "Latency") -> None:
    svg = render_line_chart(points, title, "节点数", "延迟(ms)")
...
<polyline fill="none" stroke="#ff6b6b" stroke-width="2" points="{path}"/>
</svg>"""
